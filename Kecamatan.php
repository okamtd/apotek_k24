...
class Kecamatan extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('id_kabupaten, id_provinsi, kecamatan', 'required'),
			array('id_kabupaten, id_provinsi', 'numerical', 'integerOnly'=>true),
			array('kecamatan', 'length', 'max'=>100),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id_kecamatan, id_kabupaten, id_provinsi, kecamatan', 'safe', 'on'=>'search'),
		);
	}
